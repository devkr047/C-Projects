...
void addStudent()
{
    ...
    while (k)
    {
        ...
        else if (k2==04 || k2==06 || k2==9 || k2==11)
        {
            int res=monthCheck3(k1);
            if (res==1)
            {
                system ("CLS");
                printf ("Something went wrong in your DOB.\n\nPress any key to continue.");
    ...
    while (c)
    {
        ...
        {
            choice=getch();
            if ((int)choice>=49 && (int)choice<=55)
            {
                printf ("%c",choice);
                Sleep (200);
                break;
